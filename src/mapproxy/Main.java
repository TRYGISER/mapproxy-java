...
public class Main {
  ...
  //**************************************************************************
    public Main(String[] args) throws Exception {
        ...
        args = new String[]{"C:\\Documents and Settings\\peter.borissow\\My Documents\\Java\\Libraries\\mapproxy\\src\\mapproxy\\config.xml"};
        startServer(args);
        //seedTest(args);
        //testWebServices();
        //testArcWebServices();
    ...
    private void testCapabilitiesParser(){
...
*/
      ...
      //Update the
        ...
        //http://localhost:9080/ArcGIS/?LAYERS=Default Basemap&FORMAT=png&BBOX=-12.897806,38.540149,-0.043791,51.394164&SIZE=256,256&F=image&BBOXSR=4326&IMAGESR=4326
...
//
    ...
    private void testWebServices() throws Exception {
    ...
    private void testArcWebServices() throws Exception {
   ...
   */
    ...
    private void seedTest(String[] args) throws Exception {
